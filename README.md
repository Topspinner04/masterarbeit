...
Implements the experimental setup used in the experiment for my master thesis. Code is generated by an agent in different prompt and context configurations, including a RAG configuration. The agent has access to the reference code base and stores generated code seperately for further analysis.
